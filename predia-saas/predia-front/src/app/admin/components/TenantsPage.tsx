    ...
    <div className="p-6 max-w-3xl mx-auto w-full">
      <div className="mb-8">
        ...
        <Text as="sm" className="text-muted-foreground mt-1">
          Crea y gestiona los tenants de la plataforma.
        </Text>
      </div>
          ...
          <div className="flex flex-col items-center gap-4 py-10 text-center">
            ...
            <div className="space-y-1.5">
              ...
              <Text as="sm" className="text-muted-foreground">
                El tenant <span className="font-semibold text-foreground">{created}</span> ya está listo para operar en la plataforma.
              </Text>
            </div>
              ...
              <div className="space-y-4 pl-0 sm:pl-8">
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    className="shadow-none bg-canvas"
                  />
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <Text as="caption" className="text-muted-foreground">
                    Este será el subdominio o identificador interno del tenant.
                  </Text>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="pr-9 shadow-none bg-canvas"
                    />
                    <button
                      type="button"
